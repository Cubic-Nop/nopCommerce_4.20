...
{
    [JsonObject(Title = "vendor_attribute_combination")]
    public class VendorAttributeCombinationDto : BaseDto
    {
        ...
        /// <summary>
        /// Gets or sets the attribute combination price. This way a store owner can override the default Vendor price when this attribute combination is added to the cart. For example, you can give a discount this way.
        /// </summary>
