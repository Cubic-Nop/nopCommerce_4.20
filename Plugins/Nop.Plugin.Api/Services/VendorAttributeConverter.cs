...
{
    public class VendorAttributeConverter : IVendorAttributeConverter
    {
        ...
        public List<VendorItemAttributeDto> Parse(string attributesXml)
        {
            var attributeDtos = new List<VendorItemAttributeDto>();
            ...
            try
            {
                ...
                foreach (XmlNode attributeNode in xmlDoc.SelectNodes(@"//Attributes/VendorAttribute"))
                {
                    if (attributeNode.Attributes != null && attributeNode.Attributes["ID"] != null)
                    {
                        ...
                        {
                            foreach (XmlNode attributeValue in attributeNode.SelectNodes("VendorAttributeValue"))
                            {
                                ...
                                attributeDtos.Add(new VendorItemAttributeDto { Id = attributeId, Value = value });
                            }
                        }
                    }
                }
